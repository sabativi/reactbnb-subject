...
export default class HousingDetail extends React.Component {
  render() {
    ...
    const { listing, pricing_quote } = navigation.getParam("housing");
    return (
      <View style={styles.housingDetail}>
        <Image
          style={styles.picture}
          source={{ uri: listing.picture.picture }}
        />
        <View style={styles.container}>
          <Text style={styles.description}>
            {listing.name} <Text style={styles.city}>({listing.city})</Text>
          </Text>
          <View style={styles.hostContainer}>
            <View style={styles.hostDetail}>
              ...
              <Text>
                Hôte :{" "}
                <Text style={styles.hostName}>{listing.user.first_name}</Text>
              </Text>
            </View>
            <Image
              source={{ uri: listing.user.picture_url }}
